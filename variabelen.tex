...
$\textbf{A}$ & Constraint matrix. Constant. \\ 
 ...
 & $\textbf{A}$ is op te delen in matrices $\textbf{B}$ en $\textbf{N}$. \\ % Zie 2.3
\hline
...
& $\textbf{B}$ bestaat uit de kolommen van $\textbf{A}$ die een basis vormen. \\
\hline
$\textbf{N}$ & Non-basismatrix. De kolommen van $\textbf{A}$ die niet in $\textbf{B}$ zitten. \\
\hline
